package com.s07150621.gdmec.edu.mycontacts;
...
public class ContactsTable {
    ...
    public ContactsTable(Context context){
        ...
        if(!db.isTableExits(TABLENAME)){
            String createTableSql="CREATE TABLE IF NOT EXISTS"+TABLENAME+"(id_DB integer "+"primary key AUTOINCREMENT,"+User.NAME +" VARCHAR,"+User.MOBILE +" VARCHAR,"+User.QQ+" VARCHAR,"+User.DANWEI+"VARCHAR,"+User.ADDRESS+"VARCHAR,)";
